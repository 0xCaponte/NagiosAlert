...
public class RefreshActivity extends ListActivity   {
    ...
    public void refresh() throws IOException {
        ...
        //"http://10.0.2.2:8080/Server-NagiosAlert/Actualizar"
        URL u = new URL(url);
...
//			     byte[] des_text = aes.descifrar_AES(sobre.getText(), new String(des_key));
    ...
    public void crearLista(){
		setListAdapter(new RefreshArrayAdapter(this, listaHosts , duracion, revision, status));
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		startActivity(new Intent(RefreshActivity.this, ServiceActivity.class));
	}
